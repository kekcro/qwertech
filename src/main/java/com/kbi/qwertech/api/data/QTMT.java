...
public class QTMT {
	...
	,RedCY11 =		OreDictMaterial.createMaterial(13013, "RedCY11",			"Red CY-11"			).setTextures(TextureSet.SET_FIERY			).setRGBa(200, 	20, 	20, 	255	).heat(3000, 3500											).aspects(TC.PRAECANTIO,2,TC.LUCRUM,1,TC.ORDO,1		).put(COATED,	GEMS,	STICKS,		PLATES																							).setOriginalMod(MD.QT																			).qual(MT.Ruby)
	...
	,YellowCY11 =	OreDictMaterial.createMaterial(13015, "YellowCY11",		"Yellow CY-11"		).setTextures(TextureSet.SET_FIERY			).setRGBa(200, 	200, 	20, 	255	).heat(3000, 3500											).aspects(TC.PRAECANTIO,2,TC.LUCRUM,1,TC.ORDO,1		).put(COATED,	GEMS,	STICKS,		PLATES																							).setOriginalMod(MD.QT																			).qual(MT.YellowSapphire)
	,GreenCY11 =	OreDictMaterial.createMaterial(13016, "GreenCY11",			"Green CY-11"			).setTextures(TextureSet.SET_FIERY			).setRGBa(20, 	200, 	20, 	255	).heat(3000, 3500											).aspects(TC.PRAECANTIO,2,TC.LUCRUM,1,TC.ORDO,1		).put(COATED,	GEMS,	STICKS,		PLATES																							).setOriginalMod(MD.QT																			).qual(MT.GreenSapphire)
	...
	,PurpleCY11 =	OreDictMaterial.createMaterial(13018, "PurpleCY11",		"Purple CY-11"		).setTextures(TextureSet.SET_FIERY			).setRGBa(200, 	20, 	200, 	255	).heat(3000, 3500											).aspects(TC.PRAECANTIO,2,TC.LUCRUM,1,TC.ORDO,1		).put(COATED,	GEMS,	STICKS,		PLATES																							).setOriginalMod(MD.QT																			).qual(MT.Amethyst)
	...
	,WhiteCY11 =	OreDictMaterial.createMaterial(13020, "WhiteCY11",			"White CY-11"			).setTextures(TextureSet.SET_FIERY			).setRGBa(220, 	220, 	220, 	255	).heat(3000, 3500											).aspects(TC.PRAECANTIO,2,TC.LUCRUM,1,TC.ORDO,1		).put(COATED,	GEMS,	STICKS,		PLATES																							).setOriginalMod(MD.QT																			).qual(MT.Diamond)
	...
	public static void init() {
		...
		RedCY11.addEnchantmentForTools(Enchantment.sharpness, 1).addEnchantmentForTools(Enchantment.punch, 1);
		YellowCY11.addEnchantmentForArmors(Enchantment.fireProtection,1 );
		GreenCY11.addEnchantmentForTools(Enchantment.unbreaking,1).addEnchantmentForArmors(Enchantment.protection,1);
		PurpleCY11.addEnchantmentForTools(Enchantment.efficiency, 1);
		WhiteCY11.addEnchantmentForArmors(Enchantment.blastProtection,1);
	}
}
