...
public class CraftingManagerHammer implements Runnable {
    ...
    private CraftingManagerHammer() {
        ...
        if (QTConfigs.enableArmor)
        {
            ...
            this.addRecipe(new QTArmor(3,				new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE), "L L", "CsC", 'L', OreDictPrefix.get("ring"), 'C', OreDictPrefix.get("chain"), 's', "craftingToolSaw"));
            this.addRecipe(new QTArmor(2,				new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE), "CLC", "LsL", "L L", 'L', OreDictPrefix.get("ring"), 'C', OreDictPrefix.get("chain"), 's', "craftingToolSaw"));
            this.addRecipe(new QTArmor(1,				new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE), "LsL", "CLC", "LLL", 'L', OreDictPrefix.get("ring"), 'C', OreDictPrefix.get("chain"), 's', "craftingToolSaw"));
            this.addRecipe(new QTArmor(0,				new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE), "LLL", "LLL", "LsL", 'L', OreDictPrefix.get("ring"), 's', "craftingToolSaw"));
