...
public class CraftingManager3D implements Runnable {
    ...
    public void run() {
        ...
        addRecipe(new QTArmor3D(0, TD.Processing.SMITHABLE, new Object[]{"XXX", "X X", "   ", "XXX", "XfX", "   ", "XXX", "XXX", "   ", 'X', OreDictPrefix.get("ring"), 'f', "craftingToolSaw"}));
        addRecipe(new QTArmor3D(0, TD.Processing.SMITHABLE, new Object[]{"   ", "XXX", "X X", "   ", "XXX", "XfX", "   ", "XXX", "XXX", 'X', OreDictPrefix.get("ring"), 'f', "craftingToolSaw"}));
        addRecipe(new QTArmor3D(1, TD.Processing.SMITHABLE, new Object[]{"X X", "XXX", "XXX", "X X", "XfX", "X X", "XXX", "XXX", "XXX", 'X', OreDictPrefix.get("ring"), 'f', "craftingToolSaw"}));
        addRecipe(new QTArmor3D(2, TD.Processing.SMITHABLE, new Object[]{"XXX", "X X", "XfX", "X X", "XXX", "X X", "XXX", "X X", "X X", 'X', OreDictPrefix.get("ring"), 'f', "craftingToolSaw"}));
        addRecipe(new QTArmor3D(3, TD.Processing.SMITHABLE, new Object[]{"   ", "   ", "XfX", "   ", "X X", " X ", "X X", "X X", "X X", 'X', OreDictPrefix.get("ring"), 'f', "craftingToolSaw"}));
